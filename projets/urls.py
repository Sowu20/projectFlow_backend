...
from .views import RegisterProjetView, UpdateProjetView, ListeProjetView, DeleteProjetView, ProjetDetailView, ProjetStatsView
...
urlpatterns = [
    ...
    path('project_detail/<int:id>/stats/', ProjetStatsView.as_view(), name='project_stats')
]
